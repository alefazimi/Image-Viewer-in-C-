...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_HistogramWidget_t, stringdata0) + ofs), len 
...
const QMetaObject HistogramWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_HistogramWidget.offsetsAndSize,
    qt_meta_data_HistogramWidget,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_HistogramWidget_t
